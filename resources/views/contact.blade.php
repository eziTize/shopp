                ...
                <div class="contact_right p-lg-5 p-4">
                    <form action="#" method="#">
                        ...
                        <div class="field-group">
                            ...
                            <div class="content-input-field">
                                <input name="text1" id="text1" type="email" value="" placeholder="Email Address" required="">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                                <input name="text1" id="text3" type="text" value="" placeholder="Phone Number" required="">
                            </div>
                        </div>
                        ...
                        <div class="field-group">
                            ...
                            <div class="content-input-field">
                                <input name="text1" id="text3" type="text" value="" placeholder="Inquiry Subject" required="">
                            </div>
                        </div>
                       {{-- <div class="field-group">
                            <div class="content-input-field">
